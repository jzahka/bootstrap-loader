...
function parseConfigFile(configFilePath) {
  ...
  var config = _jsYaml2.default.safeLoad(configContent);
...
function createConfig(_ref) {
  ...
  var customConfigFilePath = _ref.customConfigFilePath;
  ...
  if (!userConfigFilePath) {
    ...
    var _defaultConfig = _readDefaultConfig.defaultConfig;
    var _configFilePath = _readDefaultConfig.configFilePath;
    ...
    return {
      ...
      styleLoaders: _defaultConfig.styleLoaders,
  ...
  var userConfig = _readUserConfig.userConfig;
  var defaultConfig = _readUserConfig.defaultConfig;
  ...
  return {
    ...
    extractStylesOptions: userConfig.extractStylesOptions,
