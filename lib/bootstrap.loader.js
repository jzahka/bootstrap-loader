...
module.exports.pitch = function (source) {
  ...
  if (config.styles) {
    ...
    var styleLoaders = config.extractStyles ? (0, _buildExtractStylesLoader2.default)(styleLoadersWithSourceMapsAndResolveUrlLoader, config.extractStylesOptions) : (0, _joinLoaders2.default)(styleLoadersWithSourceMapsAndResolveUrlLoader);
